...
public class SPGlobal {
    ...
    /**
     * Path to the Data/ folder to look for plugins to import/export.<br><br>
     * By default, this is set to "../../", meaning the patch has to be in a subfolder of
     * "Data/". (ex "Data/SkyProc Patchers/My SkyProc Patcher/My Patcher.jar")
     */
    public static String pathToData = "../../";
    /**
     * Skyproc will import and embed the language given by SPGlobal.language every time a patch is created.  To offer
     * multi-language support, simply give the users of your program ability to adjust this setting.
     */
    public static String language = "English";
    /**
     * The path from the .jar location to create/look for the file used to remember
     * where the plugins.txt file is if the program cannot locate it automatically.
     */
    public static String pluginListBackupPath = "SkyProc-PluginListLocation.txt";
    /**
     * The logger object built into SkyProc. <br>
     * See the levnifty JavaDocs for more information.
     */
    ...
    /**
     * Initializes the Debug Logs in a "SkyProcDebug/" folder,
     * and allows you to print messages to them.<br>
    ...
    /**
     * Initializes the Debug Logs in a path + "SkyProcDebug/" folder,
     * and allows you to print messages to them.<br>
     * Do this step early in your program.
    ...
    /**
     * A special function that simply prints to both the debug overview and
     * the asynchronous log for easy location in either place.
     * @param header
     * @param print
     */
    ...
    /**
     * Prints messages about records pairing strings with external STRINGS files.<br>
    ...
    // SubRecords
    /**
     * Print short summary of imported subrecords after each major record is imported.<br>
     * Prints to the sync log<br>
     */
    public static boolean debugSubrecordSummary = true;
    /**
     * Print messages from all subrecord sources.  Turn this off and add
     * allowed subrecords to print only selected ones.<br>
     * Prints to the sync log<br>
     */
    public static boolean debugSubrecordAll = true;
    /**
     * Print messages from specific subrecord sources.  Only matters if
     * debugSubrecordAll is OFF.<br>
     * Prints to the sync log<br>
     */
