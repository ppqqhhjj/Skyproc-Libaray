...
public class NPC_ extends Actor implements Serializable {
    ...
    public enum AI_Data {
        ...
        /**
         * Determines when and if the NPC will attack.
         * 0: Unaggressive
         * 1: Aggressive
         * 2: Very Aggressive
         * 3: Frenzied
         ...
         * the correct conditions.<br>
         * <br>
         * No known limit.  Contact Leviathan1753 if you discover one.
         */
        AGGRO_RADIUS,
        /**
         * Determines who the NPC will assist in combat.
         * 0: Helps nobody
         * 1: Helps allies (within the same faction)
         * 2: Helps friends and allies (everyone they don't hate)
         */
        ASSISTANCE,
        /**
         * Determines at what health level the NPC will flee.
         * 0: Cowardly (always flees?)
         * 1: Cautious
         * 2: Average
         * 3: Brave
         * 4: Foolhardy (never flees?)
         */
        CONFIDENCE,
        /**
         * Determines if/when the NPC will report a crime.
         * NPC will report:
         * 0: Any crime
         * 1: Violence
     ...
     * @throws BadParameter If value is < 0, or outside the predefined range
     * of the specific AI data type.
     */
